 ...
 * COMP4471: PROJECT 2 - PROF. BENSON
 * 02-12-2015
 */
var canvas;
var gl;
...
var render = function() {
    ...
    //document.getElementById("usrDir").innerHTML = usrDir;
...
function SharkAttack() {
    //document.getElementById("sharkDir").innerHTML = sharkDir;
    //document.getElementById("usrDir").innerHTML = usrDir;
    ...
    if (sharkDir1) // back shark
    {
        ...
        //colorChange(36,15);        // Front Shark Shadow
        //colorChange(42,15);
        //colorChange(48,15);
        //colorChange(54,15);
    } else if (!sharkDir1) {
        ...
        //colorChange(36,10);        // Front Shark Normal
        //colorChange(42,10);
        //colorChange(48,10);
        //colorChange(54,10);
    }
    ...
    if (sharkDir2) // left shark
    {
        ...
        //colorChange(84,15);        // Right Shark Shadow
        //colorChange(90,15);
        //colorChange(96,15);
        //colorChange(102,15);
    } else if (!sharkDir2) {
        ...
        //colorChange(84,11);        // Right Shark Normal
        //colorChange(90,11);
        //colorChange(96,11);
        //colorChange(102,11);
    }
    ...
    if (sharkDir3) // front shark
    {
        ...
        //colorChange(60,15);        // Back Shark Shadow
        //colorChange(66,15);
        //colorChange(72,15);
        //colorChange(78,15);
    } else if (!sharkDir3) {
        ...
        //colorChange(60,13);        // Back Shark Normal
        //colorChange(66,13);
        //colorChange(72,13);
        //colorChange(78,13);
    }
    ...
    if (sharkDir4) // right shark
    {
        ...
        //colorChange(108,15);    // Left Shark Shadow
        //colorChange(114,15);
        //colorChange(120,15);
        //colorChange(126,15);
    } else if (!sharkDir4) {
        ...
        //colorChange(108,14);    // Left Shark Normal
        //colorChange(114,14);
        //colorChange(120,14);
        //colorChange(126,14);
    }
    ...
    if (sharkDir5) // bottom shark
    {
        ...
        colorChange(216, 15);
        colorChange(222, 15);
        //colorChange(132,15);    // Top Shark Shadow
        //colorChange(138,15);
        //colorChange(144,15);
        //colorChange(150,15);
    } else if (!sharkDir5) {
        ...
        colorChange(216, 12);
        colorChange(222, 12);
        //colorChange(132,12);    // Top Shark Normal
        //colorChange(138,12);
        //colorChange(144,12);
        //colorChange(150,12);
    }
    ...
    if (sharkDir6) // top shark
    {
        ...
        colorChange(240, 15);
        colorChange(246, 15);
        //colorChange(156,15);    // Bottom Shark Shadow
        //colorChange(162,15);
        //colorChange(168,15);
        //colorChange(174,15);
    } else if (!sharkDir6) {
        ...
        colorChange(240, 9);
        colorChange(246, 9);
        //colorChange(156,9);        // Bottom Shark Normal
        //colorChange(162,9);
        //colorChange(168,9);
        //colorChange(174,9);
    }
...
function timer() {
    ...
    if (sharkDir5) {
        ...
        if (count5 == 0)
            clearInterval(counter);
        //else if (((count5 % (globalCount / 5)) == 0) && sharksAtOnce != 4);
        //sharksAtOnce++;
    }
    // Top Wall
    if (sharkDir6) {
        ...
        if (count6 == 0)
            clearInterval(counter);
        //else if (((count6 % (globalCount / 5)) == 0) && sharksAtOnce != 4);
        //sharksAtOnce++;
    }
    ...
    //document.getElementById("wall5").innerHTML = count5;
    //document.getElementById("wall6").innerHTML = count6;
}
